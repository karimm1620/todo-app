...
const ProgressState = () => {
  ...
  return (
    ...
    >
      <Text style={settingsStyles.sectionTitle}>Status Progres</Text>
      ...
      <View style={settingsStyles.statsContainer}>
        ...
        >
          ...
          <View>
            ...
            <Text style={settingsStyles.statLabel}>Total Tugas</Text>
          </View>
        </LinearGradient>
        ...
        >
          ...
          <View>
            ...
            <Text style={settingsStyles.statLabel}>Selesai</Text>
          </View>
        </LinearGradient>
        ...
        >
          ...
          <View>
            ...
            <Text style={settingsStyles.statLabel}>Saat ini</Text>
          </View>
        </LinearGradient>
      </View>
    </LinearGradient>
